...
contract AbstractSubdomainRegistrar is RegistrarInterface {
    ...
    function doRegistration(bytes32 node, bytes32 label, address subdomainOwner, Resolver resolver, bytes memory contenthash) internal {
        ...
        //Set contenthash record on the resolver
    ...
    function supportsInterface(bytes4 interfaceID) public pure returns (bool) {
        return (
            ...
            || (interfaceID == 0xbc1c58d1) // ContenthashInterface
        );
    }
